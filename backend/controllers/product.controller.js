...
export const getAllProducts = async (req, res) => {
  try {
    const products = await Product.find({}); //everything
    res.json({ products });
  } catch (error) {
...
export const getFeaturedProducts = async (req, res) => {
  try {
    let featuredProducts = await redis.get("featured_products"); //return from redis will be string
    if (featuredProducts) {
